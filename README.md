...
Agora navegue até a pasta criada e abra no Visual Studio Code, execute o comando `npm install` no seu terminal para instalar todas as dependências e já estará pronto para iniciar.
